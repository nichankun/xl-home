    ...
    <section className="py-20 bg-white" id="paket">
      <div className="max-w-295 mx-auto px-6">
        ...
        <div className="text-center">
          ...
          <h2 className="font-extrabold text-3xl sm:text-4xl text-[#0A0F1E] tracking-tight">
            Paket Sesuai <em className="not-italic text-[#0057FF]">Kebutuhan Anda</em>
          </h2>
          <p className="text-base text-[#64748B] mt-3 max-w-130 mx-auto">
          ...
          {paketData[kategori].map((p) => (
            <Card
              ...
              className={`rounded-3xl p-8 border-2 relative overflow-hidden transition-all duration-300 flex flex-col shadow-none ${
                p.popular
                  ? "border-[#0057FF] bg-linear-to-b from-[#001A5C] to-[#0057FF] text-white shadow-[0_20px_60px_rgba(0,87,255,0.3)] hover:-translate-y-1.5"
                  : "border-[#E2E8F4] bg-white text-[#0A0F1E] hover:-translate-y-1.5 hover:border-[#0057FF]"
              }`}
            >
              {/* Popular Badge */}
              {p.popular && (
                <div className="absolute top-5 right-5 bg-linear-to-r from-[#FBBF24] to-[#F59E0B] text-[#78350F] text-[11px] font-bold px-3 py-1 rounded-full">
                  ⭐ Pilihan Terpopuler
                </div>
              )}
              ...
              <CardFooter className="p-0 mt-6 flex flex-col items-start w-full border-none shadow-none bg-transparent">
                ...
                <Button
                  ...
                  className={`w-full mt-5 h-auto p-3.5 rounded-xl text-md font-semibold border-none transition-all ${
                    p.popular
                      ? "bg-white text-[#0057FF] hover:bg-white/90"
                      : "bg-[#F8FAFF] text-[#0057FF] border border-[#E2E8F4] hover:bg-[#0057FF] hover:text-white"
                  }`}
                >
                  Pilih Paket
                </Button>
