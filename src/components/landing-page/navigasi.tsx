...
import { Menu, X } from "lucide-react" // Pastikan lucide-react terinstall (standar shadcn)
          ...
          <div className="flex flex-col px-6 py-6 gap-4">
            ...
            <div className="pt-2">
              <a 
                ...
                rel="noopener noreferrer"
                onClick={() => setIsOpen(false)}
                className={`flex items-center justify-center gap-2 w-full py-3 rounded-xl font-bold text-sm transition-all no-underline ${
                  scrolled
                    ? "bg-[#F0FDF4] text-[#16A34A] border border-[#DCFCE7] hover:bg-[#DCFCE7]"
